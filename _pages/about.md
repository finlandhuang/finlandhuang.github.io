...
---
I am a **Professor of Computer Science** at [Jinan University](https://jnu.edu.cn/). I serve as the deputy director of the Computational Communication Research Center and the deputy director of the Network and Education Technology Center at Jinan University. My main research directions are social networks mining, recommender systems and natural language processing. I have published more than 90 papers in top conferences and journals in the field, such as SIGIR, KDD, WWW, ACL, MM, IEEE TKDE, IEEE TIP, IJCV, etc. 
